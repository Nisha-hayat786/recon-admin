  ...
  const reportCategories = [
    {
      id: 1,
      name: 'Bills & Payments',
      description: 'Create Report of Paid, Overdue, Outstanding, Recurring, Aging.',
      icon: (
      ...
      path: '/admin/reports/bills-payments'
    },
    {
      id: 2,
      ...
      path: '/admin/reports/invoices-receipts'
    },
    {
      id: 3,
      name: 'Spending',
      description: 'Create Report of Goods and Services Broken Out of Agreement.',
      icon: (
